...
using (var channel = await connection.CreateChannelAsync())
{
    ...
    consumer.ReceivedAsync += async (sender, ea) =>
    {
        try
        {
            ...
            Console.WriteLine($"[{DateTime.Now:HH:mm:ss}] Получено сообщение: {messageText}");
    ...
    await channel.BasicConsumeAsync(queue: RabbitMqConsts.LOG_QUEQUE_1, autoAck: false, consumer: consumer);
